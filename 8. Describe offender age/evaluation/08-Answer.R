...
context({
  testcase("Leeftijd daders beschrijven", {
    # First, show educational content about summary statistics
    ...
    testEqual(
      ...
      expected,
      # Custom comparator to provide more detailed feedback
      comparator = function(got, want, ...) {
        ...
        # Display explanation about summary components
        get_reporter()$add_message(
          "## Uitleg over de summary componenten:",
          type = "markdown"
        )
