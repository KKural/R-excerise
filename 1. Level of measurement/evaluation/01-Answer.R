...
# Maak het data frame df_crime_data aan zoals hieronder:
...
# )
# Gebruik daarna de basisfuncties om de structuur en eigenschappen van het data frame te onderzoeken.
#
# Voorbeeld feedback bij elke functie:
